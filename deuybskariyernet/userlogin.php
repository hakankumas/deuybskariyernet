            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-dark shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Kullanıcı Giriş Ekranı</h4>
                </div>
              </div>
              <div class="card-body">
                <form action="/deuybskariyernet/user/islem.php" method="POST" class="text-start">
                  <br>
                  <div class="input-group input-group-outline my-3">
                    <label class="form-label">Öğrenci Numarası</label>
                    <input type="text" name="ogrenci_no" class="form-control" autofocus>
                  </div>
                  ...
                  <div class="text-center">
                    <button type="submit" name="kullanici_giris" class="btn bg-gradient-success w-100 my-4 mb-2">Giriş Yap</button>
                  </div>
                </form>
              </div>
            </div>
