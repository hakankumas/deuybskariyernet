...
include("admin_password_sorgu1.php");
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">Admin Şifresini Güncelle</h3>
                                <div class="form-floating mb-3">
                                    <select name="admin_id" class="form-control" required>
                                        <option value="" disabled selected></option>
                                        <?php foreach ($admin_listesi as $admin_list){?>
                                        <option value="<?= $admin_list->admin_id ?>"><?= $admin_list->admin_username ?></option>
                                        <?php } ?>
                                    </select>
                                    <label for="floatingPassword">Admin Kullanıcı Adı</label>
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <button type="submit" name="admin_update_password" class="btn btn-primary">Güncelle</button>
                            </form>
                        </div>
                    </div>
                </div>
