...
if(isset($_GET["kullanici_listesiid"])){
    ...
    header("location:/deuybskariyernet/user/user_search_superadmin.php?ogrenci_no=$search");
...
if(isset($_GET["kurum_listesiid"])){
    ...
    header("location:/deuybskariyernet/kurum/kurum_search_superadmin.php?kurum_id=$search");
