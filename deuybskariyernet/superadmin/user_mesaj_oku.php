                    ...
                    <div class="col-sm-12 col-xl-12">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td style="width: 100px; text-align: center;"><a href="sil.php?user_sikayet_bilgisi_oku_listesiid=<?= $user_sikayet_bilgisi_oku_list->sikayet_id ?>" class="btn btn-danger">Sil</a></td>
                            </tr>
                            <?php } ?>
                        </table>
                    </div>
