                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="post_admin_password" id="floatingInput" required autofocus>
                                    <label for="floatingInput">Mevcut Şifreniz</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="new_admin_password" id="floatingPassword" required>
                                    <label for="floatingPassword">Yeni Şifre</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="new2_admin_password" id="floatingPassword" required>
                                    <label for="floatingPassword">Yeni Şifrenizi Tekrarlayınız!</label>
                                </div>
                                <button type="submit" name="admin_own_password_update" class="btn btn-primary">Güncelle</button>
                            </form>
                        </div>
                    </div>               
                </div>
