        ...
        <div class="col-md-12 col-xl-12">
            ...
            <div class="table-responsive">
                <table id="myTable" class="table table-striped table-bordered display nowrap" style="width:100%">
                    ...
                    <?php foreach ($kurumlistesi as $kurumlist){?>
                    <tr style="text-align: center;">
                        <td style="width: 100px;"><a href="search.php?kurum_listesiid=<?= $kurumlist->kurum_id ?>" class="btn btn-info" target="_blank">Profiline Git</a></td>
                        <td style="width: 150px; text-align: center;"><?= $kurumlist->kurum_username ?></td>
                        <td style="width: 200px; text-align: center;"><?= $kurumlist->kurum_ad ?></td>
                        <td style="width: 150px; text-align: center;"><?= $kurumlist->sektor_ad ?></td>
                        <td style="width: 150px; text-align: center;"><?= $kurumlist->sehir_ad ?></td>
                        <td style="width: 150px; text-align: center;"><?= $kurumlist->kurum_telefon ?></td>
                        <td style="width: 300px; text-align: center;"><?= $kurumlist->kurum_mail ?></td>
                        <td style="width: 100px; text-align: center;"><a href="sil.php?kurumlistesiid=<?= $kurumlist->kurum_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div> 
