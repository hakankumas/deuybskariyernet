...
include("kurum_mesaj_oku_sorgu1.php");
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <h1 class="mb-2 p-5 bg-light font-weight-bold" style="text-align: center">KURUM MESAJLARI</h1>
                        <table class="table table-bordered table-striped">
                            ...
                            <?php foreach ($kurum_sikayet_bilgisi_oku_listesi as $kurum_sikayet_bilgisi_oku_list){?>
                            <tr>
                                <td hidden><?= $kurum_sikayet_bilgisi_oku_list->sikayet_id ?></td>
                                <td style="width: 100px; text-align: center;"><a href="search.php?kurum_mesajlistesiid=<?= $kurum_sikayet_bilgisi_oku_list->kurum_id ?>" class="btn btn-info" target="_blank">Profiline Git</a></td>
                                <td style="width: 200px; text-align: center;"><?= $kurum_sikayet_bilgisi_oku_list->kurum_ad ?></td>
                                <td style="width: 250px; text-align: center;"><?= $kurum_sikayet_bilgisi_oku_list->sikayet_baslik ?></td>
                                <td style="text-align: left;"><?= $kurum_sikayet_bilgisi_oku_list->sikayet_metni ?></td>
                                <td style="width: 100px; text-align: center;"><a href="sil.php?kurum_sikayet_bilgisi_oku_listesiid=<?= $kurum_sikayet_bilgisi_oku_list->sikayet_id ?>" class="btn btn-danger">Sil</a></td>
                            </tr>
                            <?php } ?>
                        </table>
                    </div>
