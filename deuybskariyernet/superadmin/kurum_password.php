...
include("kurum_password_sorgu1.php");
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">Kurum Şifresini Güncelle</h3>
                                <div class="form-floating mb-3">
                                    <select name="kurum_id" class="form-control" required>
                                        <option value="" disabled selected></option>
                                        <?php foreach ($kurum_listesi as $kurumlist){?>
                                        <option value="<?= $kurumlist->kurum_id ?>"><?= $kurumlist->kurum_username ?></option>
                                        <?php } ?>
                                    </select>
                                    <label for="floatingPassword">Kurum Kullanıcı Adı</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="kurum_password" id="floatingPassword" required>
                                    <label for="floatingPassword">Yeni Bir Şifre Belirleyin</label>
                                </div>
                                <button type="submit" name="kurum_update_password" class="btn btn-primary">Güncelle</button>
                            </form>
                        </div>
                    </div>
                </div>
