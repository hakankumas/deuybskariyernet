...
include("kurum_bildirimler_sorgu1.php");
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php foreach ($kurum_bildirim_listesi as $kurum_bildirim_list){?>
                    <tr>
                        <td hidden><?= $kurum_bildirim_list->admintokurum_id ?></td>
                        <td hidden><?= $kurum_bildirim_list->kurum_id ?></td>
                        <td style="text-align: left; padding-left: 30px;"><?= $kurum_bildirim_list->admintokurum_mesaj ?></td>
                        <td style="width: 100px; text-align: center;"><a href="sil.php?kurum_bildirim_listesiid=<?= $kurum_bildirim_list->admintokurum_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
