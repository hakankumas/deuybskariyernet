                    ...
                    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <ul class="nav navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="/deuybskariyernet/admin/index.php">Ana Sayfa<i class="fa fa-home"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/deuybskariyernet/admin/user_edit.php">Kullanıcılar<i class="fa fa-user"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/deuybskariyernet/admin/kurum_edit.php">Kurumlar<i class="fa fa-building"></i></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
