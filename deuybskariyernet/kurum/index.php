    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" style="width:40px; height:40px; border-radius: 100px; display: block; margin: auto;" src="<?= $kurum_bilgisi_list->resim ?>">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <h5 class="mb-0">
                            <?= $kurum_bilgisi_list->kurum_ad ?>
                        </h5>
                        <span>
                            <?="@$kurum_bilgisi_list->kurum_username" ?>
                        </span>
                    </div>
                </div>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" style="width:40px; height:40px; border-radius: 100px;" src="<?= $kurum_bilgisi_list->resim ?>">
            ...
            <div class="container-fluid pt-4 px-4 mb-5">
                <div class="row g-4">
                    <div class="col-md-12">
                        <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">İLANLARINIZA UYGUN KULLANICILAR</h3>
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <table class="table table-bordered table-striped">
                                <tr class="font-weight-bold">
                                    <th hidden>Öğrenci No</th>
                                ...
                                <?php foreach ($kurumun_istegine_uygun_kullanicilar_listesi as $kurumun_istegine_uygun_kullanicilar_list){?>
                                <tr>
                                    <td hidden><?= $kurumun_istegine_uygun_kullanicilar_list->ogrenci_no ?></td>
                                    <td style="width: q100px; text-align: center;"><a href="search.php?kurumun_istegine_uygun_kullanicilar_listesiid=<?= $kurumun_istegine_uygun_kullanicilar_list->ogrenci_no ?>" class="btn btn-info" target="_blank">Profile Git</a></td>
                                    <td style="width: q170px; text-align: center;"><?= $kurumun_istegine_uygun_kullanicilar_list->kullanici_ad ?> <?= $kurumun_istegine_uygun_kullanicilar_list->kullanici_soyad ?></td>
                                    <td style="width: q200px; text-align: center;"><?= $kurumun_istegine_uygun_kullanicilar_list->kullanicituru_ad ?></td>
                                    <td style="width: q150px; text-align: center;"><?= $kurumun_istegine_uygun_kullanicilar_list->kullanicicalismadurumu_ad ?></td>
                                </tr>
                                <?php } ?>
                            </table>
                        </div>
