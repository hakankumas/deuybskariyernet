                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-recycle" aria-hidden="true"></i>Bilgileri Güncelle</a>
                                    <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                                        <a href="info.php" class="dropdown-item mt-1 text-white"><i class="fa fa-arrow-right pr-3"></i>Kurumsal Bilgi</a>
                                        <a href="kurum_sosyalmedya_olustur.php" class="dropdown-item mt-1 text-white"><i class="fa fa-arrow-right pr-3"></i>Sosyal Medya Adresleri</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-recycle" aria-hidden="true"></i>Yayındakiler</a>
                                    <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                                        <a href="kurum_ilan_olustur.php" class="dropdown-item mt-1 text-white"><i class="fa fa-arrow-right pr-3"></i>İlanlar</a>
                                        <a href="kurum_etkinlik_olustur.php" class="dropdown-item mt-1 text-white"><i class="fa fa-arrow-right pr-3"></i>Etkinlikler</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
