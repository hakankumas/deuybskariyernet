...
include("kurum_sikayet_sorgu1.php");
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-items-center text-center yukseklik">
                <div id="logreg-forms" class="w-50 px-5 py-5 mt-5 mx-auto bg-light text-dark">
                    <form action="islem.php" method="post" class="form-signup">
                        <h1 class="h3 mb-3 font-weight-bold" style="text-align: center">YENİ BİR ŞİKAYET OLUŞTUR</h1>
                        <br><br>
                        ...
                        <br>
                        <button class="btn btn-primary btn-block" name="kurum_sikayet_ekle" type="submit">GÖNDER</button>
                        <br>          
            ...
            <div class="col">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">Daha Önce Oluşturduğunuz Öneriler</h3>
                <table class="table table-bordered table-striped">
                    ...
                    <?php foreach ($kurumun_sikayet_bilgisi_listesi as $kurumun_sikayet_bilgisi_list){?>
                    <tr>
                        <td hidden><?= $kurumun_sikayet_bilgisi_list->sikayet_id ?></td>
                        <td style="width: 270px; text-align: center;"><?= $kurumun_sikayet_bilgisi_list->sikayet_baslik ?></td>
                        <td style="text-align: left;"><?= $kurumun_sikayet_bilgisi_list->sikayet_metni ?></td>
                        <td style="width: 130px; text-align: center;"><a href="sil.php?kurumun_sikayet_bilgisi_listesiid=<?= $kurumun_sikayet_bilgisi_list->sikayet_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
