...
$etkinlik_id = htmlspecialchars($_GET["etkinlik_id"]);
include("baglan2.php");
include("kurum_etkinliklere_basvuranlar_sorgu1.php");
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">ETKİNLİĞE BAŞVURANLAR</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <td hidden>Etkinlik Başvurusu ID</td>
                        <td style="text-align: center;">Etkinlik ID</td>
                    ...
                    <?php foreach ($kurumun_etkinlik_basvuru_bilgisi_listesi as $kurumun_etkinlik_basvuru_bilgisi_list){?>
                    <tr>
                        <td hidden><?= $kurumun_etkinlik_basvuru_bilgisi_list->etkinlik_basvurusu_id ?></td>
                        <td style="width: %10; text-align: center;"><?= $kurumun_etkinlik_basvuru_bilgisi_list->etkinlik_id ?></td>
                        <td style="width: %40; text-align: center;"><?= $kurumun_etkinlik_basvuru_bilgisi_list->etkinlik_ad ?></td>
                        <td style="width: %20; text-align: center;"><?= $kurumun_etkinlik_basvuru_bilgisi_list->etkinlik_tarihi ?></td>
                        <td style="width: %20; text-align: center;"><?= $kurumun_etkinlik_basvuru_bilgisi_list->ogrenci_no ?></td>
                        <td style="width: %10; text-align: center;"><a href="search.php?kurumun_etkinliklerine_basvuran_listesiid=<?= $kurumun_etkinlik_basvuru_bilgisi_list->ogrenci_no ?>" class="btn btn-info">Profiline Git</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
