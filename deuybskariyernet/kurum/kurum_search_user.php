                            ...
                            <div class="col-md-12">
                                <div class="edu-col">
                                    <?php foreach ($kurum_ilan_bilgisi_listesi as $kurum_ilan_bilgisi_list){?>
                                        ...
                                        <a href="/deuybskariyernet/user/basvur.php?user_kurum_ilan_bilgisi_listesiid=<?= $kurum_ilan_bilgisi_list->ilan_id ?>" class="btn btn-success">Başvur</a>
                                        <br>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="edu-col">
                                    <?php foreach ($kurum_etkinlik_bilgisi_listesi as $kurum_etkinlik_bilgisi_list){?>
                                        ...
                                        <p class="pb-3"><a class="text-danger" href="<?= $kurum_etkinlik_bilgisi_list->etkinlik_link ?>" class="btn btn-success" target="_blank">Link Adresi</a></p>
                                        <a href="/deuybskariyernet/user/basvur.php?user_kurum_etkinlik_bilgisi_listesiid=<?= $kurum_etkinlik_bilgisi_list->etkinlik_id ?>" class="btn btn-success">Başvur</a>
                                        <br>
                                    <?php } ?>
                                </div>
                            </div>
                ...
                <div class="contact" id="contact">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="form">
                                    <form action="/deuybskariyernet/user/islem.php" method="POST">
                                        <input type="hidden" name="kurum_id" value="<?= $kurum_id;?>">
                                        <div class="form-group">
                                            <textarea class="form-control" name="kullanicitokurum_mesaj" rows="5" placeholder="Mesaj"></textarea>
                                        </div>
                                        <button class="btn btn-primary btn-block" name="kullanicitokurum" type="submit">GÖNDER</button>
                                    </form>
                                </div>
                            </div>
                        </div>
