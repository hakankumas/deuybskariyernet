...
include("baglan2.php");
include("user_sertifika_sorgu1.php");
?>
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-items-center text-center yukseklik">
                <div id="logreg-forms" class="w-50 px-5 py-5 mt-5 mx-auto bg-light text-dark">
                    <form action="islem.php" method="post" class="form-signup">
                        <h1 class="h3 mb-3 font-weight-bold" style="text-align: center">YENİ BİR SERTİFİKA EKLE</h1>
                        <br><br>
                        <input type="text" name="sertifika_ad" class="form-control" required autofocus placeholder=" Sertifika Adı">
                        <br>
                        <input type="text" name="kurum_ad" class="form-control" required placeholder=" Kurum Adı">
                        <br>
                        <input type="text" name="tarih" id="datepicker1" class="form-control" placeholder=" Alınma Tarihi">
                        <br>
                        <div class="form-floating">
                            <textarea class="form-control" placeholder=" Açıklama"
                                name="sertifika_aciklama" style="height: 100px;"></textarea>
                        </div>
                        <br>
                        <button class="btn btn-primary btn-block" name="user_sertifika_ekle" type="submit">EKLE</button>
                        <br>          
            ...
            <div class="col">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">SERTİFİKA BİLGİLERİM</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <td hidden>Kullanıcı Sertifika ID</td>
                        <td style="text-align: center;">Alınma Tarihi</td>
                        <td style="text-align: center;">Sertifika Adı</td>
                        <td style="text-align: center;">Kurum Adı</td>
                        <td style="text-align: center;">Açıklama</td>
                        <td style="text-align: center;">Sil</td>
                    </tr>
                    <?php foreach ($user_sertifika_bilgisi_listesi as $user_sertifika_bilgisi_list){?>
                    <tr>
                        <td hidden><?= $user_sertifika_bilgisi_list->kullanici_sertifika_id ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_sertifika_bilgisi_list->tarih ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_sertifika_bilgisi_list->sertifika_ad ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_sertifika_bilgisi_list->kurum_ad ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_sertifika_bilgisi_list->sertifika_aciklama ?></td>
                        <td style="width: 100px; text-align: center;"><a href="sil.php?user_sertifika_bilgisi_listesiid=<?= $user_sertifika_bilgisi_list->kullanici_sertifika_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
