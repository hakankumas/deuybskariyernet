    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary p-4" style="font-size: 17px;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active ml-4 mr-4">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Ayarlar</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="user_profil">Profil Resmi</a>
                        <a class="dropdown-item" href="password.php">Şifre Güncelle</a>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-items-center text-center yukseklik">
                <div id="logreg-forms" class="w-50 px-5 py-5 mt-5 mx-auto bg-light text-dark">
                    <form action="islem.php" method="post" class="form-signup" enctype="multipart/form-data">
                        <h1 class="h3 mb-3 font-weight-bold" style="text-align: center">PROFİL FOTOĞRAFINI GÜNCELLE</h1>
                        <br><br>
                        <input type="file" name="resim" class="form-control" required>
                        <br>
                        <button class="btn btn-primary btn-block" name="user_pp_ekle" type="submit">EKLE</button>
                    </form>
                </div>
            </div>
        </div>
