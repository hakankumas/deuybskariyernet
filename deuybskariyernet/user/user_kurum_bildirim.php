...
include("baglan2.php");
include("user_kurum_bildirim_sorgu1.php");
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">KURUM MESAJLARI</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold" style="text-align: center;">
                        <td style="text-align: center;">Profiline Git</td>
                        <td hidden>Kurum Mesajı ID</td>
                    ...
                    <?php foreach ($user_kurum_bildirim_listesi as $user_kurum_bildirim_list){?>
                    <tr>
                        <td style="width: 100px; text-align: center;"><a href="search.php?user_kurum_bildirim_listesiid=<?= $user_kurum_bildirim_list->kurum_id ?>" class="btn btn-info" target="_blank">Profiline Git</a></td>
                        <td hidden><?= $user_kurum_bildirim_list->kurumtokullanici_id ?></td>
                        <td hidden><?= $user_kurum_bildirim_list->kurum_id ?></td>
                        <td style="width: 25%; text-align: center;"><?= $user_kurum_bildirim_list->kurum_ad ?></td>
                        <td hidden><?= $user_kurum_bildirim_list->ogrenci_no ?></td>
                        <td style="text-align: left; padding-left: 30px;"><?= $user_kurum_bildirim_list->kurumtokullanici_mesaj ?></td>
                        <td style="width: 100px; text-align: center;"><a href="sil.php?user_kurum_bildirim_listesiid=<?= $user_kurum_bildirim_list->kurumtokullanici_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
