...
include("baglan2.php");
include("user_bildirimler_sorgu1.php");
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">ADMİN MESAJLARI</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <td hidden>Admin Mesajı ID</td>
                        <td hidden>Öğrenci No 1</td>
                        <td hidden>Öğrenci No 2</td>
                        <td hidden>Öğrenci No 3</td>
                        <td hidden>Kullanıcı Eş ID</td>
                        <td hidden>Kullanıcı Çocuk ID</td>
                        <td hidden>Öğrenci No 4</td>
                        <td style="text-align: center;">Bildirim</td>
                        <td style="text-align: center;">Sil</td>
                    </tr>
                    <?php foreach ($user_bildirim_listesi as $user_bildirim_list){?>
                    <tr>
                        <td hidden><?= $user_bildirim_list->admintouser_id ?></td>
                        <td hidden><?= $user_bildirim_list->ogrenci_no1 ?></td>
                        <td hidden><?= $user_bildirim_list->ogrenci_no2 ?></td>
                        <td hidden><?= $user_bildirim_list->ogrenci_no3 ?></td>
                        <td hidden><?= $user_bildirim_list->kullanici_es_id ?></td>
                        <td hidden><?= $user_bildirim_list->kullanici_cocuk_id ?></td>
                        <td hidden><?= $user_bildirim_list->ogrenci_no4 ?></td>
                        <td style="text-align: left; padding-left: 30px;"><?= $user_bildirim_list->admintouser_mesaj ?></td>
                        <td style="width: 100px; text-align: center;"><a href="sil.php?user_bildirim_listesiid=<?= $user_bildirim_list->admintouser_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
