    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4 mb-5">
                <div class="row g-4">
                    <div class="col-md-12">
                        <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">PROFİLİNİZE UYGUN İŞ İLANLARI</h3>
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <table class="table table-bordered table-striped">
                                <tr class="font-weight-bold">
                                    <th hidden>İlan ID</th>
                                    <th hidden>Kurum ID</th>
                                    <th style="text-align: center;">Profile Git</th>
                                    <th style="text-align: center;">Kurum Adı</th>
                                    <th style="text-align: center;">Pozisyon</th>
                                    <th style="text-align: center;">Şehir</th>
                                    <th style="text-align: center;">İlan Türü</th>
                                    <th style="text-align: center;">Başvur</th>
                                </tr>
                                <?php foreach ($kullanicinin_profiline_uygun_ilanlar_listesi as $kullanicinin_profiline_uygun_ilanlar_list){?>
                                <tr>
                                    <td hidden><?= $kullanicinin_profiline_uygun_ilanlar_list->ilan_id ?></td>
                                    <td hidden><?= $kullanicinin_profiline_uygun_ilanlar_list->kurum_id ?></td>
                                    <td style="width: 100px; text-align: center;"><a href="search.php?kullanicinin_profiline_uygun_ilanlar_listesiid=<?= $kullanicinin_profiline_uygun_ilanlar_list->kurum_id ?>" class="btn btn-info" target="_blank">Profile Git</a></td>
                                    <td style="width: 170px; text-align: center;"><?= $kullanicinin_profiline_uygun_ilanlar_list->kurum_ad ?></td>
                                    <td style="width: 200px; text-align: center;"><?= $kullanicinin_profiline_uygun_ilanlar_list->pozisyon_ad ?></td>
                                    <td style="text-align: center;"><?= $kullanicinin_profiline_uygun_ilanlar_list->sehir_ad ?></td>
                                    <td style="width: 150px; text-align: center;"><?= $kullanicinin_profiline_uygun_ilanlar_list->ilanturu_ad ?></td>
                                    <td style="width: 100px; text-align: center;"><a href="basvur.php?kullanicinin_profiline_uygun_ilanlar_listesiid=<?= $kullanicinin_profiline_uygun_ilanlar_list->ilan_id ?>" class="btn btn-success">Başvur</a></td>
                                </tr>
                                <?php } ?>
                            </table>
                        </div>
