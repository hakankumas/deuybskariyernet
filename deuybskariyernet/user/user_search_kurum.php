                    ...
                    <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <ul class="nav navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="/deuybskariyernet/kurum/index.php">Ana Sayfa<i class="fa fa-home"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/deuybskariyernet/kurum/users.php">Kullanıcılar<i class="fa fa-user"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/deuybskariyernet/kurum/kurums.php">Kurumlar<i class="fa fa-building"></i></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                ...
                <div class="contact" id="contact">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="form">
                                    <form action="/deuybskariyernet/kurum/islem.php" method="POST">
                                        <input type="hidden" name="kurum_id" value="<?= $kurum_id;?>">
                                        <input type="hidden" name="ogrenci_no" value="<?= $ogrenci_no;?>">
                                        <div class="form-group">
                                            <textarea class="form-control" name="kurumtokullanici_mesaj" rows="5" placeholder="Mesaj"></textarea>
                                        </div>
                                        <button class="btn btn-primary btn-block" name="kurumtokullanici" type="submit">GÖNDER</button>
                                    </form>
                                </div>
                            </div>
                        </div>
