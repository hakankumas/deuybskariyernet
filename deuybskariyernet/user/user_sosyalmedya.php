...
include("baglan2.php");
include("user_sosyalmedya_sorgu1.php");
include("user_sosyalmedya_sorgu2.php");
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-items-center text-center yukseklik">
                <div id="logreg-forms" class="w-50 px-5 py-5 mt-5 mx-auto bg-light text-dark">
                    <form action="islem.php" method="post" class="form-signup">
                        <h1 class="h3 mb-3 font-weight-bold" style="text-align: center">YENİ BİR SOSYAL MEDYA ADRESİ EKLE</h1>
                        <br><br>
                        <select name="sosyalmedya_id" class="form-control" required autofocus>
                            ...
                            <option value="<?= $sosyalmedya->sosyalmedya_id ?>">
                            <?= $sosyalmedya->sosyalmedya_platform ?></option>
                            <?php } ?>
                        </select>
                        <br>
                        ...
                        <br>
                        <button class="btn btn-primary btn-block" name="user_sosyalmedya_ekle" type="submit">EKLE</button>
                        <br>          
            ...
            <div class="col">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">YETENEKLERİM</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <td hidden>Kullanıcı Sosyal Medya ID</td>
                        <td style="text-align: center;">Platform</td>
                        <td style="text-align: center;">Link</td>
                        <td style="text-align: center;">Sil</td>
                    </tr>
                    <?php foreach ($user_sosyalmedya_bilgisi_listesi as $user_sosyalmedya_bilgisi_list){?>
                    <tr>
                        <td hidden><?= $user_sosyalmedya_bilgisi_list->kullanici_sosyalmedya_id ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_sosyalmedya_bilgisi_list->sosyalmedya_platform ?></td>
                        <td style="width: 400px; text-align: center;"><?= $user_sosyalmedya_bilgisi_list->link ?></td>
                        <td style="width: 150px; text-align: center;"><a href="sil.php?user_sosyalmedya_bilgisi_listesiid=<?= $user_sosyalmedya_bilgisi_list->kullanici_sosyalmedya_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
