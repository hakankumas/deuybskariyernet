...
include("baglan2.php");
include("user_ilgialani_sorgu1.php");
?>
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-items-center text-center yukseklik">
                <div id="logreg-forms" class="w-50 px-5 py-5 mt-5 mx-auto bg-light text-dark">
                    <form action="islem.php" method="post" class="form-signup">
                        <h1 class="h3 mb-3 font-weight-bold" style="text-align: center">YENİ BİR İLGİ ALANI EKLE</h1>
                        <br><br>
                        <input type="text" name="ilgialani_ad" class="form-control" required placeholder=" İlgi Alanı">
                        <br>
                        <button class="btn btn-primary btn-block" name="user_ilgialani_ekle" type="submit">EKLE</button>
                        <br>          
            ...
            <div class="col">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">İLGİ ALANLARIM</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <td hidden>Kullanıcı İlgi Alanı ID</td>
                        <td style="text-align: center;">İlgi Alanı</td>
                        <td style="text-align: center;">Sil</td>
                    </tr>
                    <?php foreach ($user_ilgi_alani_bilgisi_listesi as $user_ilgi_alani_bilgisi_list){?>
                    <tr>
                        <td hidden><?= $user_ilgi_alani_bilgisi_list->kullanici_ilgi_alani_id ?></td>
                        <td style="text-align: center;"><?= $user_ilgi_alani_bilgisi_list->ilgialani_ad ?></td>
                        <td style="width: 150px; text-align: center;"><a href="sil.php?user_ilgi_alani_bilgisi_listesiid=<?= $user_ilgi_alani_bilgisi_list->kullanici_ilgi_alani_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
