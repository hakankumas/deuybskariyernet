...
include("baglan2.php");
include("user_kurum_duyuru_sorgu1.php");
?>
...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">KURUM DUYURULARI</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <th hidden>Kurum Duyuru ID</th>
                        <th hidden>Kurum ID</th>
                        <td style="text-align: center;">Profile Git</td>
                        <th style="text-align: center;">Kurum Ad</th>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px; text-align: center;"><a href="search.php?kurum_duyuru_listesiid=<?= $kurum_duyuru_list->kurum_id ?>" class="btn btn-info" target="_blank">Profile Git</a></td>
                        <td style="width: 30%; text-align: center;"><?= $kurum_duyuru_list->kurum_ad ?></td>
                        <td style="text-align: left; padding-left: 30px;"><?= $kurum_duyuru_list->kurumtokullanici_duyuru_mesaji ?></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
