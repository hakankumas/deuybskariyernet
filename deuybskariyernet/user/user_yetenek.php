...
include("baglan2.php");
include("user_yetenek_sorgu1.php");
            ...
            <div class="col-md-12 d-flex justify-content-center align-items-center text-center yukseklik">
                <div id="logreg-forms" class="w-50 px-5 py-5 mt-5 mx-auto bg-light text-dark">
                    <form action="islem.php" method="post" class="form-signup">
                        <h1 class="h3 mb-3 font-weight-bold" style="text-align: center">YENİ BİR YETENEK EKLE</h1>
                        <br><br>
                        <input type="text" name="yetenek_ad" class="form-control" required autofocus placeholder="Yetenek">
                        <br>
                        <button class="btn btn-primary btn-block" name="user_yetenek_ekle" type="submit">EKLE</button>
                        <br>          
            ...
            <div class="col">
                ...
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <td hidden>Kullanıcı Yetenek ID</td>
                        <td style="text-align: center;">Yetenek</td>
                        <td style="text-align: center;">Sil</td>
                    </tr>
                    <?php foreach ($user_yetenek_bilgisi_listesi as $user_yetenek_bilgisi_list){?>
                    <tr>
                        <td hidden><?= $user_yetenek_bilgisi_list->kullanici_yetenek_id ?></td>
                        <td style="text-align: center;"><?= $user_yetenek_bilgisi_list->yetenek_ad ?></td>
                        <td style="width: 150px; text-align: center;"><a href="sil.php?user_yetenek_bilgisi_listesiid=<?= $user_yetenek_bilgisi_list->kullanici_yetenek_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
