...
<body>
    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center align-items-center text-center yukseklik">
                <div id="logreg-forms" class="w-50 px-5 py-5 mt-5 mx-auto bg-light text-dark">
                    <form action="islem.php" method="post" class="form-signup">
                        <h1 class="h3 mb-3 font-weight-bold" style="text-align: center">YENİ BİR PROJE EKLE</h1>
                        <br><br>
                        <input type="text" name="proje_adi" class="form-control" required autofocus placeholder=" Proje Adı">
                        <br>
                        <input type="text" name="tarih" id="datepicker1" class="form-control" placeholder=" Tarih">
                        <br>
                        <div class="form-floating">
                            <textarea class="form-control" placeholder=" Açıklama"
                                name="proje_aciklama" style="height: 100px;"></textarea>
                        </div>
                        <br>
                        <button class="btn btn-primary btn-block" name="user_proje_ekle" type="submit">EKLE</button>
                        <br>          
            ...
            <div class="col">
                <br><br><br>
                <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">PROJELERİM</h3>
                <table class="table table-bordered table-striped">
                    <tr class="font-weight-bold">
                        <td hidden>Kullanıcı Proje ID</td>
                        <td style="text-align: center;">Tarih</td>
                        <td style="text-align: center;">Projenin Adı</td>
                        <td style="text-align: center;">Açıklama</td>
                        <td style="text-align: center;">Sil</td>
                    </tr>
                    <?php foreach ($user_proje_bilgisi_listesi as $user_proje_bilgisi_list){?>
                    <tr>
                        <td hidden><?= $user_proje_bilgisi_list->kullanici_proje_id ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_proje_bilgisi_list->tarih ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_proje_bilgisi_list->proje_adi ?></td>
                        <td style="width: 200px; text-align: center;"><?= $user_proje_bilgisi_list->proje_aciklama ?></td>
                        <td style="width: 100px; text-align: center;"><a href="sil.php?user_proje_bilgisi_listesiid=<?= $user_proje_bilgisi_list->kullanici_proje_id ?>" class="btn btn-danger">Sil</a></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
