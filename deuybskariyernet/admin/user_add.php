                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">Kullanıcı Ekle</h3>
                                <div class="form-floating mb-3">
                                    <input type="text" name="ogrenci_no" class="form-control" required autofocus>
                                    <label for="floatingInput">Kullanıcı Adı</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="kullanici_password" class="form-control" required>
                                    <label for="floatingPassword">Şifre</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <select name="kullanicituru_id" id="kullanicituru_id" class="form-control" required>
                                        <option value="" disabled selected></option>
                                        <option value="1">Öğrenci</option>
                                        <option value="2">Mezun</option>
                                    </select>
                                    <label for="floatingPassword">Kullanıcı Türü</label>
                                </div>
                                <button type="submit" name="admin_kullaniciekle" id="admin_kullaniciekle" class="btn btn-primary">Ekle</button>
                    ...
                    <div class="col-md-8">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                                <h3 class="mb-4">Toplu Kullanıcı Ekle</h3>
                                <h6><i>Örnek Şablon: ogrenci_no, kullanici_password, kullanicituru_id(1:Öğrenci | 2:Mezun)</i></h6>
                                <h6><i>Önemli Uyarı: Şablonu oluşturduktan sonra excel dosyasından başlıkları siliniz.</i></h6>
                                <div class="form-floating mb-3 mt-4">
                                    <input type="file" name="file" id="file" accept=".xls,.xlsx" required autofocus>   
                                </div>
                                <button type="submit" name="admin_multiuseradd" id="submit" class="btn btn-primary">Ekle</button>
                            </form>
                        </div>
                    </div>
                </div>
