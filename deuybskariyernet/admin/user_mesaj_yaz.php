...
include("user_mesaj_yaz_sorgu1.php");
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">Kullanıcıya Mesaj Gönder</h3>
                                <div class="form-floating mb-3">
                                    <select name="ogrenci_no4" class="form-control" required>
                                        <option value="" disabled selected></option>
                                        <?php foreach ($user_listesi as $user_list){?>
                                        <option value="<?= $user_list->ogrenci_no ?>"><?= "$user_list->kullanici_ad $user_list->kullanici_soyad" ?></option>
                                        <?php } ?>
                                    </select>
                                    <label for="floatingPassword">Kullanıcı Seçiniz</label>
                                </div>
                                <div class="form-signup mb-3">
                                    <textarea class="form-control" placeholder="Mesajınızı Yazınız"
                                        name="admintouser_mesaj" 
                                        style="height: 150px;" required></textarea>
                                </div>
                                <button type="submit" name="admin_kullanici_mesaj_yaz" class="btn btn-primary">Gönder</button>
