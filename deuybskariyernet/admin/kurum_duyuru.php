...
include("kurum_duyuru_sorgu1.php");
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-md-8">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">KURUMLAR İÇİN TOPLU DUYURU YAYINLA</h3>
                                <div class="form-signup mb-3">
                                    <textarea class="form-control" placeholder="Mesajınızı Yazınız"
                                        name="admintokurum_duyuru_mesaji" 
                                        style="height: 150px;" required></textarea>
                                </div>
                                <button type="submit" name="admintokurum_duyuru" class="btn btn-primary">Gönder</button>
                    ...
                    <div class="col-md-12 mb-5">
                        <br><br><br>
                        <h3 class="mb-1 p-5 bg-light font-weight-bold" style="text-align: center">KURUMLAR İÇİN YAYINLANMIŞ DUYURULAR</h3>
                        <table class="table table-bordered table-striped">
                            ...
                            <?php foreach ($admintokurum_duyuru_listesi as $admintokurum_duyuru_list){?>
                            <tr>
                                <td hidden><?= $admintokurum_duyuru_list->admintokurum_duyuru_id ?></td>
                                <td style="text-align: left; padding-left: 30px;"><?= $admintokurum_duyuru_list->admintokurum_duyuru_mesaji ?></td>
                                <td style="width: 100px; text-align: center;"><a href="sil.php?admintokurum_duyuru_listesiid=<?= $admintokurum_duyuru_list->admintokurum_duyuru_id ?>" class="btn btn-danger">Sil</a></td>
                            </tr>
                            <?php } ?>
                        </table>
                    </div>
