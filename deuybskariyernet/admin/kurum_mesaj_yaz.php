                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">Kuruma Mesaj Gönder</h3>
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="floatingPassword">Kurum Seçiniz</label>
                                </div>
                                <div class="form-signup mb-3">
                                    <textarea class="form-control" placeholder="Mesajınızı Yazınız"
                                        name="admintokurum_mesaj" 
                                        style="height: 150px;" required></textarea>
                                </div>
                                <button type="submit" name="admin_kurum_mesaj_yaz" class="btn btn-primary">Gönder</button>
