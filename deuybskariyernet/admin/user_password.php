...
include("user_password_sorgu1.php");
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">Kullanıcı Şifresini Güncelle</h3>
                                <div class="form-floating mb-3">
                                    <select name="ogrenci_no" class="form-control" required>
                                        <option value="" disabled selected></option>
                                        <?php foreach ($user_listesi as $user_list){?>
                                        <option value="<?= $user_list->ogrenci_no ?>"><?= $user_list->ogrenci_no ?></option>
                                        <?php } ?>
                                    </select>
                                    <label for="floatingPassword">Öğrenci NO</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="kullanici_password" id="floatingPassword" required>
                                    <label for="floatingPassword">Yeni Bir Şifre Belirleyin</label>
                                </div>
                                <button type="submit" name="kullanici_update_password" class="btn btn-primary">Güncelle</button>
                            </form>
                        </div>
                    </div>
                </div>
