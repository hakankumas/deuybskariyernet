                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST">
                                <h3 class="mb-4">Kurum Ekle</h3>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="kurum_username" id="kurum_username" required autofocus>
                                    <label for="floatingInput">Kullanıcı Adı</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="kurum_password" id="kurum_password" required>
                                    <label for="floatingPassword">Şifre</label>
                                </div>
                                <button type="submit" name="admin_kurumekle" id="admin_kurumekle" class="btn btn-primary">Ekle</button>
                    ...
                    <div class="col-md-6">
                        <div class="bg-light rounded h-100 p-4">
                            <form action="islem.php" method="POST" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                                <h3 class="mb-4">Toplu Kurum Ekle</h3>
                                <h6><i>Örnek Şablon: kurum_username, kurum_password</i></h6>
                                ...
                                <button type="submit" name="admin_multikurumadd" id="submit" class="btn btn-primary">Ekle</button>
                            </form>
                        </div>
                    </div>
                </div>
